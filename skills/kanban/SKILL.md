...
# Press e to edit, m to move, D to delete, / to search
```
...
- **Markdown cards** are synchronized exports, not the authoritative edit path. Direct markdown edits are not imported; use CLI, TUI, WebUI, or MCP writes to change cards.
